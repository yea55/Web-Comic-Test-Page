 ...
 * 
 * artist_portal.php allows users with artist accounts to upload images and modify data 
	...
	$_SESSION['logged'] )  //Check the flag variable to see if user has been logged in
{
	...
	elseif (mysql_num_rows($result))
	{
		...
		if ($password == $row[1])
		{
			...
			echo "Click <a href='index.php'>here to go back to the index</a>.<br />";
			...
			echo '<form action="artist_portal.php" method="post" enctype="multipart/form-data"><pre>';
